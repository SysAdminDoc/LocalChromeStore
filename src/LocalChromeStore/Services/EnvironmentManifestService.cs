...
public static class EnvironmentManifestService
{
    ...
    private static EnvironmentExtensionSnapshot ToSnapshot(InstalledExtension e) => new()
    {
        ...
        AssetDigest = e.AssetDigest,
        AssetSizeBytes = e.AssetSizeBytes,
        AssetId = e.AssetId,
        AssetContentType = e.AssetContentType,
        AssetUploader = e.AssetUploader,
        AssetCreatedAt = e.AssetCreatedAt,
        AssetUpdatedAt = e.AssetUpdatedAt,
        AssetDownloadCount = e.AssetDownloadCount,
        ReleasePublishedAt = e.ReleasePublishedAt,
